...
cisco_device = {
       ...
       'host': connect_list[0],
       'username': connect_list[2],
       'password': connect_list[3],
       'port': connect_list[1],             # optional, default 22
       'secret': connect_list[4],      # this is the enable password
